...
class NamesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post names_url, params: { name: { description: @name.description, image_url: @name.image_url, price: @name.price, section_id: @name.section_id } }
    end
  ...
  test "should update name" do
    patch name_url(@name), params: { name: { description: @name.description, image_url: @name.image_url, price: @name.price, section_id: @name.section_id } }
